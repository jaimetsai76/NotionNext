...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jaime Tsai', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '40岁重启人生，记录成长分享成长', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jaimetsai.com', // 网站地址
  KEYWORDS:
    process.env.NEXT_PUBLIC_KEYWORD ||
    'Jaime Tsai, 音乐, 信仰, AI, 日本生活准备, 个人成长', // 网站关键词 英文逗号隔开
